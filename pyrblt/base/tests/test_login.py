...
from pyrblt.django_assertions import assert_contains, assert_not_contains
...
def test_usuario_logado_disponivel(resp_home_com_usuario_logado, usuario_logado):
